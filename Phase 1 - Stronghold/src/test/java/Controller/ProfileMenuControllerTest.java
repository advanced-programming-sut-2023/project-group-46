...
class ProfileMenuControllerTest {
    ...
    void testChangeNicknameAction() throws Exception {
        ...
        String expectedOutput2 = "[{\"password\":\"testPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"newNickname\",\"email\":\"testUser@example.com\",\"username\":\"testUser\",\"numberOfSecurityQuestion\":0}]";
        String expectedOutput3 = "[{\"highScore\":0,\"password\":\"testPassword\",\"stayedLoggedIn\":false,\"nickname\":\"newNickname\",\"email\":\"testUser@example.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
        String expectedOutput4 = "[{\"password\":\"testPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"newNickname\",\"email\":\"testUser@example.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
    ...
    void testChangePasswordAction() throws Exception {
        ...
        String expectedOutput2 = "[{\"password\":\"newPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"testUser@example.com\",\"username\":\"testUser\",\"numberOfSecurityQuestion\":0}]";
        String expectedOutput3 = "[{\"highScore\":0,\"password\":\"newPassword\",\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"testUser@example.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
        String expectedOutput4 = "[{\"password\":\"newPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"testUser@example.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
    ...
    void testChangeEmailAction() throws Exception {
        ...
        String expectedOutput2 = "[{\"password\":\"testPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"newEmail@gmail.com\",\"username\":\"testUser\",\"numberOfSecurityQuestion\":0}]";
        String expectedOutput3 = "[{\"highScore\":0,\"password\":\"testPassword\",\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"newEmail@gmail.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
        String expectedOutput4 = "[{\"password\":\"testPassword\",\"highScore\":0,\"stayedLoggedIn\":false,\"nickname\":\"Test User\",\"email\":\"newEmail@gmail.com\",\"numberOfSecurityQuestion\":0,\"username\":\"testUser\"}]";
