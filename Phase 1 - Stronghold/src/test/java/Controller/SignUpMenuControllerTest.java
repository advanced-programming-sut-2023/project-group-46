...
class SignUpMenuControllerTest {
    ...
    void testWriteInJsonFile() throws Exception {
        ...
        String expectedOutput = "[{\"answer to security question\":\"\",\"password\":\"testPassword\",\"nickname\":\"Test User\",\"slogan\":\"Test slogan\",\"number of security question\":0,\"isStayedLoggedIn\":\"f\",\"email\":\"testUser@example.com\",\"username\":\"testUser\"}]";
