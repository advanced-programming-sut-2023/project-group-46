...
public class GameMenuController {
    ...
    private String nextTurn() {
        /*
        selections should be null

        remove destroyed things, remove from both map and empire arraylist

        check end of the game

        give points in a method you want

        unemployed people, maximum population

        fear rate and popularity factors which mohammadhasan implemented should be called
