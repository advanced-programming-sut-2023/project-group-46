...
public class AvatarMenu extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        one= new ImageView(LoginMenu.class.getResource("/Image/Avatar/9.png").toString());
        two= new ImageView(LoginMenu.class.getResource("/Image/Avatar/10.png").toString());
        three= new ImageView(LoginMenu.class.getResource("/Image/Avatar/7.png").toString());
        four= new ImageView(LoginMenu.class.getResource("/Image/Avatar/8.png").toString());
...
//        Data.setAvatars(avatars);
        ...
        pane.getChildren().addAll(one, two, three, four, button);
