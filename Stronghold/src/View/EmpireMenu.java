...
public class EmpireMenu {
    ...
    public void run() {
        ...
        while (true) {
            ...
            } else if ((matcher = Menu.getMatcher(command, "food rate -r (?<rate>-?\\d+)")) != null) {
            ...
            } else if ((matcher = Menu.getMatcher(command, "tax rate -r (?<rate>-?\\d+)")) != null) {
            ...
            } else if ((matcher = Menu.getMatcher(command, "fear rate -r (?<rate>-?\\d+)")) != null) {
